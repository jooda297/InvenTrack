...
<?php }?>
    ...
    <div class="d-flex align-items-center mt-3">
        <!-- MINUS -->
        <a href="UpdateCartQty.php?action=dec&cart_id=<?php echo $cart_id ?>" 
           class="btn btn-sm rounded-circle bg-light border me-2">
            <i class="fa fa-minus"></i>
        </a>

        <!-- CURRENT QTY -->
        <span class="mx-1 fw-bold"><?php echo $qty ?></span>

        <!-- PLUS -->
        <a href="UpdateCartQty.php?action=inc&cart_id=<?php echo $cart_id ?>" 
           class="btn btn-sm rounded-circle bg-light border ms-2">
...
<td>
    <a href="./DeleteFromCart.php?cart_id=<?php echo $cart_id ?>" 
